...
afterEach(async () => {
  ...
  await dbQuery('DELETE FROM blogs');
...
describe('Blog API', () => {
  ...
  it('should get all blogs', async () => {
    ...
    await dbQuery('INSERT INTO blogs (title, content) VALUES ($1, $2)', ['Blog 1', 'Content 1']);
    await dbQuery('INSERT INTO blogs (title, content) VALUES ($1, $2)', ['Blog 2', 'Content 2']);
  ...
  it('should get a single blog by id', async () => {
    ...
    const result = await dbQuery('INSERT INTO blogs (title, content) VALUES ($1, $2) RETURNING *', ['Blog 1', 'Content 1']);
